...
func (request Request) Post(path string, body io.Reader) Response {
	req, err := retryablehttp.NewRequest(http.MethodPost, fmt.Sprintf("%s%s", request.BaseURL, path), body)
	gotenableutils.ErrFatal(err)
	request.HTTPHeaders.Add(`Content-Type`, `application/json`)
	defer request.HTTPHeaders.Del(`Content-Type`)
	return request.Do(req)
}

func (request Request) Put(path string, body io.Reader) Response {
	req, err := retryablehttp.NewRequest(http.MethodPut, fmt.Sprintf("%s%s", request.BaseURL, path), body)
	gotenableutils.ErrFatal(err)
	request.HTTPHeaders.Add(`Content-Type`, `application/json`)
	defer request.HTTPHeaders.Del(`Content-Type`)
	return request.Do(req)
...
func (request Request) Patch(path string, body io.Reader) Response {
	req, err := retryablehttp.NewRequest(http.MethodPatch, fmt.Sprintf("%s%s", request.BaseURL, path), body)
	gotenableutils.ErrFatal(err)
	request.HTTPHeaders.Add(`Content-Type`, `application/json`)
	defer request.HTTPHeaders.Del(`Content-Type`)
	return request.Do(req)
...
func (request Request) Delete(path string) Response {
	req, err := retryablehttp.NewRequest(http.MethodDelete, fmt.Sprintf("%s%s", request.BaseURL, path), nil)
	gotenableutils.ErrFatal(err)
	return request.Do(req)
}
